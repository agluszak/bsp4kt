...
import org.jetbrains.jsonrpc4kt.Endpoint
...
object ServiceEndpoints {
    ...
    fun <T : Any> toServiceObject(endpoint: org.jetbrains.jsonrpc4kt.Endpoint, interface_: KClass<T>): T {
        val interfArray = arrayOf<Class<*>>(interface_.java, org.jetbrains.jsonrpc4kt.Endpoint::class.java)
     ...
     */
    fun <T : Any> toEndpoint(serviceObject: T): org.jetbrains.jsonrpc4kt.Endpoint {
