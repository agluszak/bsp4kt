...
import org.jetbrains.jsonrpc4kt.messages.Message.Companion.CONTENT_TYPE_HEADER
import org.jetbrains.jsonrpc4kt.messages.Message.Companion.CRLF
import org.jetbrains.jsonrpc4kt.messages.Message.Companion.JSON_MIME_TYPE
        ...
        coroutineScope.launch {
            ...
            for (message in messageChannel) {
                ...
                try {
                    ...
                    if (org.jetbrains.jsonrpc4kt.JsonRpcException.indicatesStreamClosed(exception)) {
                        println("stream closed")
                        break
                    }
                    println("got $exception when trying to write $message")
                    throw org.jetbrains.jsonrpc4kt.JsonRpcException(exception)
                }
            }
